  ...
  return (
    ...
    <Col sm={6} className="col-style left-side">
      ...
      <Card className="login-todx">
        <Card.Header as="h5" className="header-card">تسجيل دخول</Card.Header>
        <Card.Body className="body-card">
          ...
          <Button variant="outline-primary" onClick={()=>{ props.history.push(`/DashBord`)}} className="button-login"> دخول</Button>
        </Card.Body>
